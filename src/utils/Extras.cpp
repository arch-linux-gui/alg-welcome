...
void
setCalamaresRunningForTest( bool running )
{
...
void
runCalamaresIfLiveISO( bool isLiveISO )
{
    ...
    std::thread(
        []
        {
            ...
            if ( process.exitCode() != 0 )
            {
                ...
                spdlog::error( "Calamares stderr: {}",
                               QString::fromUtf8( process.readAllStandardError() ).toStdString() );
            }
            else
            {
                spdlog::debug( "Calamares stdout: {}",
                               QString::fromUtf8( process.readAllStandardOutput() ).toStdString() );
            }
